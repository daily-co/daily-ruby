...
module Daily
  ...
  class ParticipantJoinedPayloadPermissions
    ...
    def self.openapi_types
      {
        ...
        :'can_send' => :'Array<String>',
        :'can_admin' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Daily::ParticipantJoinedPayloadPermissions` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Daily::ParticipantJoinedPayloadPermissions`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'can_send')
        if (value = attributes[:'can_send']).is_a?(Array)
          self.can_send = value
        end
      end

      if attributes.key?(:'can_admin')
        if (value = attributes[:'can_admin']).is_a?(Array)
          self.can_admin = value
        end
      end
    end
