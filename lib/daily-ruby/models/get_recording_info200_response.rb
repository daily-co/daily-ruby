...
module Daily
  class GetRecordingInfo200Response
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ["finished", "in-progress", "canceled", "unknown_default_open_api"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["finished", "in-progress", "canceled", "unknown_default_open_api"])
