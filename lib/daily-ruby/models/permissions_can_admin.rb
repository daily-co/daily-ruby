...
module Daily
  # Which admin tasks a participant is permitted to do.  Can be: - An array containing any of `'participants'`, `'streaming'`, or `'transcription'` - `true` (meaning \"all\") - `false` (meaning \"none\")
  module PermissionsCanAdmin
    class << self
