...
module Daily
  # Configures an S3 bucket in which to store recordings. See the [S3 bucket guide](/guides/products/live-streaming-recording/storing-recordings-in-a-custom-s3-bucket) for more information.  Properties:
  class RecordingsBucket
    ...
    attr_accessor :allow_streaming_from_bucket
    ...
    def self.attribute_map
      {
        ...
        :'allow_streaming_from_bucket' => :'allow_streaming_from_bucket'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Daily::RecordingsBucket` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Daily::RecordingsBucket`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'allow_streaming_from_bucket')
        self.allow_streaming_from_bucket = attributes[:'allow_streaming_from_bucket']
      else
        self.allow_streaming_from_bucket = false
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          allow_streaming_from_bucket == o.allow_streaming_from_bucket
    end
    ...
    def hash
      [bucket_name, bucket_region, assume_role_arn, allow_api_access, allow_streaming_from_bucket].hash
    end
