  ...
  class Webhook
    ...
    def self.attribute_map
      {
        ...
        :'last_moment_pushed' => :'lastMomentPushed',
        :'domain_id' => :'domainId',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Daily::Webhook` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Daily::Webhook`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'last_moment_pushed')
        self.last_moment_pushed = attributes[:'last_moment_pushed']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          last_moment_pushed == o.last_moment_pushed &&
