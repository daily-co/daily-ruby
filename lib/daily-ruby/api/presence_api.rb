...
module Daily
  class PresenceApi
    ...
    def get_presence(opts = {})
      data, _status_code, _headers = get_presence_with_http_info(opts)
      data
    end
    ...
    def get_presence_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PresenceApi.get_presence",
