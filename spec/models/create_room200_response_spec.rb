...
# Unit tests for Daily::CreateRoom200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Daily::CreateRoom200Response do
  let(:instance) { Daily::CreateRoom200Response.new }

  describe 'test an instance of CreateRoom200Response' do
    it 'should create an instance of CreateRoom200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Daily::CreateRoom200Response)
    end
  end
