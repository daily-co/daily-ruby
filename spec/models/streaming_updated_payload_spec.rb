...
# Unit tests for Daily::StreamingUpdatedPayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Daily::StreamingUpdatedPayload do
  let(:instance) { Daily::StreamingUpdatedPayload.new }

  describe 'test an instance of StreamingUpdatedPayload' do
    it 'should create an instance of StreamingUpdatedPayload' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Daily::StreamingUpdatedPayload)
    end
  end
