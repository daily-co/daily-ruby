...
# Unit tests for Daily::DailyStreamingOptions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Daily::DailyStreamingOptions do
  let(:instance) { Daily::DailyStreamingOptions.new }

  describe 'test an instance of DailyStreamingOptions' do
    it 'should create an instance of DailyStreamingOptions' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Daily::DailyStreamingOptions)
    end
  end
