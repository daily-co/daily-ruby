...
# Unit tests for Daily::RoomsRoomNameGetRes
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Daily::RoomsRoomNameGetRes do
  let(:instance) { Daily::RoomsRoomNameGetRes.new }

  describe 'test an instance of RoomsRoomNameGetRes' do
    it 'should create an instance of RoomsRoomNameGetRes' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Daily::RoomsRoomNameGetRes)
    end
  end
