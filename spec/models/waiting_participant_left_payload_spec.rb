...
# Unit tests for Daily::WaitingParticipantLeftPayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Daily::WaitingParticipantLeftPayload do
  let(:instance) { Daily::WaitingParticipantLeftPayload.new }

  describe 'test an instance of WaitingParticipantLeftPayload' do
    it 'should create an instance of WaitingParticipantLeftPayload' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Daily::WaitingParticipantLeftPayload)
    end
  end
