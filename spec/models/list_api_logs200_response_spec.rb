...
# Unit tests for Daily::ListAPILogs200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Daily::ListAPILogs200Response do
  let(:instance) { Daily::ListAPILogs200Response.new }

  describe 'test an instance of ListAPILogs200Response' do
    it 'should create an instance of ListAPILogs200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Daily::ListAPILogs200Response)
    end
  end
