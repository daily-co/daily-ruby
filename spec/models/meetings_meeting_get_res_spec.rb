...
# Unit tests for Daily::MeetingsMeetingGetRes
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Daily::MeetingsMeetingGetRes do
  let(:instance) { Daily::MeetingsMeetingGetRes.new }

  describe 'test an instance of MeetingsMeetingGetRes' do
    it 'should create an instance of MeetingsMeetingGetRes' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Daily::MeetingsMeetingGetRes)
    end
  end
