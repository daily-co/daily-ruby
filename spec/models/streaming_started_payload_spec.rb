...
# Unit tests for Daily::StreamingStartedPayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Daily::StreamingStartedPayload do
  let(:instance) { Daily::StreamingStartedPayload.new }

  describe 'test an instance of StreamingStartedPayload' do
    it 'should create an instance of StreamingStartedPayload' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Daily::StreamingStartedPayload)
    end
  end
