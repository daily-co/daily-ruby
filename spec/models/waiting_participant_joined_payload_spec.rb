...
# Unit tests for Daily::WaitingParticipantJoinedPayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Daily::WaitingParticipantJoinedPayload do
  let(:instance) { Daily::WaitingParticipantJoinedPayload.new }

  describe 'test an instance of WaitingParticipantJoinedPayload' do
    it 'should create an instance of WaitingParticipantJoinedPayload' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Daily::WaitingParticipantJoinedPayload)
    end
  end
