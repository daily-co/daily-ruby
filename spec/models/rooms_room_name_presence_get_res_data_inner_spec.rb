...
# Unit tests for Daily::RoomsRoomNamePresenceGetResDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Daily::RoomsRoomNamePresenceGetResDataInner do
  let(:instance) { Daily::RoomsRoomNamePresenceGetResDataInner.new }

  describe 'test an instance of RoomsRoomNamePresenceGetResDataInner' do
    it 'should create an instance of RoomsRoomNamePresenceGetResDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Daily::RoomsRoomNamePresenceGetResDataInner)
    end
  end
