...
# Unit tests for Daily::RoomsRoomNamePresenceGetRes
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Daily::RoomsRoomNamePresenceGetRes do
  let(:instance) { Daily::RoomsRoomNamePresenceGetRes.new }

  describe 'test an instance of RoomsRoomNamePresenceGetRes' do
    it 'should create an instance of RoomsRoomNamePresenceGetRes' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Daily::RoomsRoomNamePresenceGetRes)
    end
  end
