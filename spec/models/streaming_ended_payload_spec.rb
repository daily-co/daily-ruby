...
# Unit tests for Daily::StreamingEndedPayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Daily::StreamingEndedPayload do
  let(:instance) { Daily::StreamingEndedPayload.new }

  describe 'test an instance of StreamingEndedPayload' do
    it 'should create an instance of StreamingEndedPayload' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Daily::StreamingEndedPayload)
    end
  end
