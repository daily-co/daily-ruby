...
# Unit tests for Daily::DeleteTranscript200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Daily::DeleteTranscript200Response do
  let(:instance) { Daily::DeleteTranscript200Response.new }

  describe 'test an instance of DeleteTranscript200Response' do
    it 'should create an instance of DeleteTranscript200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Daily::DeleteTranscript200Response)
    end
  end
