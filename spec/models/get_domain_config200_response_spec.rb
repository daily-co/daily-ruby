...
# Unit tests for Daily::GetDomainConfig200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Daily::GetDomainConfig200Response do
  let(:instance) { Daily::GetDomainConfig200Response.new }

  describe 'test an instance of GetDomainConfig200Response' do
    it 'should create an instance of GetDomainConfig200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Daily::GetDomainConfig200Response)
    end
  end
