...
# Unit tests for Daily::ListRecordings200ResponseDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Daily::ListRecordings200ResponseDataInner do
  let(:instance) { Daily::ListRecordings200ResponseDataInner.new }

  describe 'test an instance of ListRecordings200ResponseDataInner' do
    it 'should create an instance of ListRecordings200ResponseDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Daily::ListRecordings200ResponseDataInner)
    end
  end
