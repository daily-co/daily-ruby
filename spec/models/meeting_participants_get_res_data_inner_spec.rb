...
# Unit tests for Daily::MeetingParticipantsGetResDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Daily::MeetingParticipantsGetResDataInner do
  let(:instance) { Daily::MeetingParticipantsGetResDataInner.new }

  describe 'test an instance of MeetingParticipantsGetResDataInner' do
    it 'should create an instance of MeetingParticipantsGetResDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Daily::MeetingParticipantsGetResDataInner)
    end
  end
