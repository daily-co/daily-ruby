...
# Unit tests for Daily::CreateRoomRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Daily::CreateRoomRequest do
  let(:instance) { Daily::CreateRoomRequest.new }

  describe 'test an instance of CreateRoomRequest' do
    it 'should create an instance of CreateRoomRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Daily::CreateRoomRequest)
    end
  end
