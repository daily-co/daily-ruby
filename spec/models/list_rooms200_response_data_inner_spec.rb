...
# Unit tests for Daily::ListRooms200ResponseDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Daily::ListRooms200ResponseDataInner do
  let(:instance) { Daily::ListRooms200ResponseDataInner.new }

  describe 'test an instance of ListRooms200ResponseDataInner' do
    it 'should create an instance of ListRooms200ResponseDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Daily::ListRooms200ResponseDataInner)
    end
  end
