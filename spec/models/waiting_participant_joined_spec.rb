...
# Unit tests for Daily::WaitingParticipantJoined
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Daily::WaitingParticipantJoined do
  let(:instance) { Daily::WaitingParticipantJoined.new }

  describe 'test an instance of WaitingParticipantJoined' do
    it 'should create an instance of WaitingParticipantJoined' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Daily::WaitingParticipantJoined)
    end
  end
