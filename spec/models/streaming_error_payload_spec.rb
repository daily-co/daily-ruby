...
# Unit tests for Daily::StreamingErrorPayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Daily::StreamingErrorPayload do
  let(:instance) { Daily::StreamingErrorPayload.new }

  describe 'test an instance of StreamingErrorPayload' do
    it 'should create an instance of StreamingErrorPayload' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Daily::StreamingErrorPayload)
    end
  end
