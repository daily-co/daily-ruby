...
# Unit tests for Daily::SetRoomConfigRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Daily::SetRoomConfigRequest do
  let(:instance) { Daily::SetRoomConfigRequest.new }

  describe 'test an instance of SetRoomConfigRequest' do
    it 'should create an instance of SetRoomConfigRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Daily::SetRoomConfigRequest)
    end
  end
