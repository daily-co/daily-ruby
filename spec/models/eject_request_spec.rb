...
# Unit tests for Daily::EjectRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Daily::EjectRequest do
  let(:instance) { Daily::EjectRequest.new }

  describe 'test an instance of EjectRequest' do
    it 'should create an instance of EjectRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Daily::EjectRequest)
    end
  end
