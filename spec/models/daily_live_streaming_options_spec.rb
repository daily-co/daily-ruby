...
# Unit tests for Daily::DailyLiveStreamingOptions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Daily::DailyLiveStreamingOptions do
  let(:instance) { Daily::DailyLiveStreamingOptions.new }

  describe 'test an instance of DailyLiveStreamingOptions' do
    it 'should create an instance of DailyLiveStreamingOptions' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Daily::DailyLiveStreamingOptions)
    end
  end
