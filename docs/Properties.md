...
| **user_id** | **String** | The user&#39;s ID for this meeting session. This ID is retrievable using the [meetings](/reference/rest-api/meetings) API. You can use &#x60;user_id&#x60; to map between your user database and meeting events/attendance. *The ID does not display in our standard in-call UI during the call.  _max length 36 chars_ | [optional] |
